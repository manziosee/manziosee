...
- **Other:** Docker, Linux, Git, Fly.io, GraphQL, UI/UX
...
|:--------|:-----------|:------------|
| [**auditshield**](https://github.com/manziosee/auditshield) | Angular · Django · GraphQL · PostgreSQL | Multi-tenant SaaS for business compliance |
